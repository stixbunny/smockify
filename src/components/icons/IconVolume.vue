...
import type { VolumePower } from '../../types';
...
<template>
  ...
  <template v-else-if="props.mode == 'medium'">
    <svg
      role="presentation"
      height="16"
      width="16"
  ...
  <template v-else-if="props.mode == 'high'">
    <svg
      role="presentation"
      height="16"
      width="16"
  ...
  <template v-else-if="props.mode == 'muted'">
    <svg
      role="presentation"
      height="16"
      width="16"
